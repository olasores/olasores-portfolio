...
export default function HomeSection() {
    return (
        <div className="flex min-h-screen items-center justify-center bg-black font-sans dark:bg-black px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 g max-w-4xl w-full items-center">
                ...
                <div className="flex justify-center md:justify-end">
                    <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full bg-white overflow-hidden flex items-center justify-center">
                        <img 
