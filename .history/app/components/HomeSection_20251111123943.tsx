...
export default function HomeSection() {
    return (
        <div className="flex min-h-screen items-start justify-center bg-black font-sans dark:bg-black px-6 py-5 pt-50">
            <div className="w-full max-w-[700px] flex flex-col gap-12 items-center">
                {/* Text content */}
