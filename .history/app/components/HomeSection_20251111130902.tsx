            ...
            <div className="max-w-[700px] w-full flex flex-col gap-12">
                ...
                <div className="flex flex-col gap-6 items-center md:items-start">
                    ...
                    <p className="text-base md:text-lg text-gray-300 leading-relaxed max-w-lg">
                        I go by name is Ola, a senior studying computer science at California state university, Fullerton. I enjoy listening to music and reading during my free time.
                    </p>
